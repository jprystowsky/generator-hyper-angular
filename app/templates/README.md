# <%= projectName %> [![Build Status](https://travis-ci.org/<%= githubUsername %>/<%= _.slugify(_.humanize(projectName)) %>.svg?branch=master)](https://travis-ci.org/<%= githubUsername %>/<%= _.slugify(_.humanize(projectName)) %>) [![Dependency Status](https://david-dm.org/<%= githubUsername %>/<%= _.slugify(_.humanize(projectName)) %>.svg?theme=shields.io)](https://david-dm.org/<%= githubUsername %>/<%= _.slugify(_.humanize(projectName)) %>)
