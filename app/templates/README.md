# <%= projectName %> [![Build Status](https://img.shields.io/travis/<%= githubUsername %>/<%= _.slugify(_.humanize(projectName)) %>.svg)](https://travis-ci.org/<%= githubUsername %>/<%= _.slugify(_.humanize(projectName)) %>) [![Coverage Status](https://img.shields.io/coveralls/<%= githubUsername %>/<%= _.slugify(_.humanize(projectName)) %>.svg)](https://coveralls.io/r/<%= githubUsername %>/<%= _.slugify(_.humanize(projectName)) %>) [![Dependency Status](https://david-dm.org/<%= githubUsername %>/<%= _.slugify(_.humanize(projectName)) %>.svg?theme=shields.io)](https://david-dm.org/<%= githubUsername %>/<%= _.slugify(_.humanize(projectName)) %>)
